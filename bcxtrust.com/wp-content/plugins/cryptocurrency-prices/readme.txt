...
* easily accept orders and payments: Bitcoin (BTC),
* accept donations: Bitcoin (BTC),
* plugin translations: German, Italian, .pot file provided. 

= Premium version features: = 
* all free features, plus:
* custom designs themes: light, dark,
* easily accept orders and payments: Ethereum (ETH), Litecon (LTC), Zcash (ZEC),
* accept donations: Ethereum (ETH), Litecon (LTC), Monero (XMR), Zcash (ZEC),
* remove all external links.

[Get the premium version only for 10 USD](https://creditstocks.com/cryptocurrency-one-wordpress-plugin/)
...
Supported currencies for payments are: Bitcoin (BTC) (default), Ethereum (ETH) (premium version), Litecon (LTC) (premium version).
...
Add a shortcode to the text of the pages or posts where you want to accept payments (typically these pages would contain a product or service that you are offering). The amount may be in BTC (default), Ethereum (ETH) (premium version), Litecon (LTC) (premium version) or in fiat currency (USD, EUR, etc), which will be converted it to the selected cryptocurrency. 
Exapmle shortcodes:
...
Supported currencies are: Bitcoin (BTC) (default), Ethereum (ETH) (premium version), Litecon (LTC) (premium version), Monero (XMR) (premium version), Zcash (ZEC) (premium version). Exapmle shortcodes (do not forget to put your wallet address):
...
This plugin uses data from third party public APIs. By installing this plugin you agree with their terms: [CryptoCompare Public API](https://www.cryptocompare.com/api/) - no API key required, under [Creative Commons license](https://creativecommons.org/licenses/by-nc/3.0/), [Google Charts API](https://developers.google.com/chart/terms). Special thanks to: Emil Samsarov, theox89.

### Donations

If you have benefited from this WordPress plugin and feel led to send me a monetary donation, please follow the link [here](http://creditstocks.com/donate/). Everybody who donates 10+ USD will receive the Cryptocurrency All-in-One premium plugin on their email.
...
Please visit this page to get Cyptocurrency All-in-One Premium: https://creditstocks.com/cryptocurrency-one-wordpress-plugin/  
...
The free version takes the styles from your theme. The premium version is provided with design styles. In both versions you can write CSS code for custom styles - use the "Custom design" field in the plugin settings. 
...
You can easily remove the link from the plugin settings page. The premium version additionally provides the option to remove all external links. 
