...
function mtlistings_register_cmb2_metaboxes() {

	$cmb_demo = new_cmb2_box( array(
		'id'            => 'mt_listings_metabox',
		'title'         => esc_html__( 'Test Metabox2', 'cmb2' ),
		'object_types'  => array( 'mt_listing' ), // Post type
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Test Textxx', 'cmb2' ),
...
// add_action( 'cmb2_admin_init', 'mtlistings_register_cmb2_metaboxes' );
