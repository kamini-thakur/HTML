    ...
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        ...
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                ...
                'Home Crypto Blockchain' => array(
                    'image-hero3.zip'
                ),
                'Home Crypto Coacher' => array(
                    'home-crypto-trainer.zip'
                ),
                'Home Crypto ICO' => array(
                    'image-hero3.zip'
                ),
                'Home Crypto Stats' => array(
                    'image-hero31.zip'
                ),
                'Home ICO Consultant' => array(
                    'homeicoconsultant.zip'
                ),
                'Home Trading Platform' => array(
                    'trading_slider.zip'
                ),
                'Home Exchange' => array(
                    'image-hero31.zip'
                ...
                'Home Listings Filter' => array(
                    'listings.zip'
                ),
                'Home Smart Contract' => array(
                    'smartcontract_slider.zip'
                ),
                'ICO Landing Page' => array(
                    'trading_slider.zip'
                ),
                'ICO Landing Page 2' => array(
                    'trading_slider.zip'
                ),
                'Home Shop' => array(
                    'home_shop.zip'
        ...
        */
        ...
        $wbc_home_pages = array(
            'Main Home'                 => 'Main Home',
            'Home Crypto Blockchain'                 => 'Home Crypto Blockchain',
            'Home Crypto Coacher'                 => 'Home Crypto Coacher',
            'Home Crypto ICO'                 => 'Home Crypto ICO',
            'Home Crypto Stats'                 => 'Home Crypto Stats',
            'Home ICO Consultant'                 => 'Home ICO Consultant',
            'Home Trading Platform'                 => 'Home Trading Platform',
            'Home Exchange'                 => 'Home Exchange',
            'Home Blogging'                 => 'Home Blogging',
            'Home Listings Filter'                 => 'ICO Listing filter',
            'Home Smart Contract'                 => 'Home Smart Contract',
            'ICO Landing Page'                 => 'ICO Landing Page',
            'ICO Landing Page 2'                 => 'ICO Landing Page 2',
            'Home Shop'                 => 'Home Shop',
        );
