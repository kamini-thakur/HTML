  ...
  'use strict';
	...
	jQuery( document ).ready(function() {
		...
		*/
		...
		var font = jQuery('#mt_select_font').val();

		if (font == "cryptocoins_icons"){

			jQuery(".cmb_id_mt_font_cryptocoins_icons").show();

			jQuery(".cmb_id_mt_font_awesome_icons").hide();

			jQuery(".cmb_id_mt_font_simple_line_icons").hide();

		} else if(font == "font_awesome_icons") {

			jQuery(".cmb_id_mt_font_cryptocoins_icons").hide();

			jQuery(".cmb_id_mt_font_awesome_icons").show();

			jQuery(".cmb_id_mt_font_simple_line_icons").hide();

		} else if(font == "simple_line_icons") {

			jQuery(".cmb_id_mt_font_cryptocoins_icons").hide();

			jQuery(".cmb_id_mt_font_awesome_icons").hide();

			jQuery(".cmb_id_mt_font_simple_line_icons").show();			

		}



		jQuery('#mt_select_font').on('change', function() {
