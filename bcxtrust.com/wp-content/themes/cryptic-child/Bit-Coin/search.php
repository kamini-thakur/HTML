...
/*
Template Name: Bit Coin Search  template
*/
...
<div class="float-widget">
  <a href="<?php echo site_url(); ?>/buy-crypto/bit-coin/faucets/" class="btn btn-green btn-lg btn-round"><i class="fa fa-btc" aria-hidden="true"></i> Free Bitcoin</a>
</div>
