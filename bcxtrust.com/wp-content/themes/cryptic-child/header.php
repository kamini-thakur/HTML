...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/css/simple-line-icons.css">
    <link rel='stylesheet' href='<?php echo get_stylesheet_directory_uri(); ?>/assets/css/cryptocoins.css' type='text/css' media='all' />
      <!-- Images -->
    <link rel="icon" href="<?php echo get_stylesheet_directory_uri(); ?>/Bit-Coin/assets/img/favicon.png" />
    <!-- External CSS -->
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-T8Gy5hrqNKT+hzMclPo118YTQO6cYprQmhrYwIiQ/3axmI1hQomh7Ud2hPOy8SP1" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/css/bootstrap-select.min.css">
    <link href="https://fonts.googleapis.com/css?family=Lato:300,400,700" rel="stylesheet">
  <!-- Custom CSS -->
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/Bit-Coin/assets/css/ember.css?v=<?php echo time(); ?>" rel="stylesheet">
      <!-- Bootstrap core CSS -->
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/Bit-Coin/assets/css/bootstrap.min.css" rel="stylesheet">
